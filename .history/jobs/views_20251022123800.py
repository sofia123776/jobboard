            ...
            'experience': [
                {
                    ...
                    'dates': ['2022-Present'],
                    'description': ['Developed web applications', 'Team collaboration']
                }
            ],
            'skills': ['python', 'django', 'javascript', 'react', 'sql'],
            'years_experience': 2.5,
            'summary': 'Experienced software developer with 2.5 years of experience skilled in Python, Django, JavaScript, and React.'
        }
@login_required
