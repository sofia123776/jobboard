...
urlpatterns = [
    ...
    path('dashboard/network/', views.network_dashboard, name='network_dashboard'),
    path('dashboard/network/suggestions/', views.network_suggestions, name='network_suggestions'),
    path('dashboard/network/connections/', views.network_connections, name='network_connections'),
    path('dashboard/profile/<str:username>/', views.profile_view, name='profile_view'),
    path('dashboard/profile/<str:username>/follow/', views.follow_user, name='follow_user'),
    path('dashboard/profile/<str:username>/unfollow/', views.follow_user, name='unfollow_user'),
    path('dashboard/profile/<str:username>/connections/', views.network_connections, name='connections_list'),
]
