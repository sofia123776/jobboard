...
def connections_list(request, username):
    ...
    return render(request, 'connections_list.html', context)
...
def network_suggestions(request):
    ...
    return render(request, 'network_suggestions.html', context)@login_required
def network_dashboard(request):
    ...
    return render(request, 'network_dashboard.html', context)
...
def network_suggestions(request):
    ...
    return render(request, 'network_suggestions.html', context)
...
def network_connections(request):
    ...
    return render(request, 'network_connections.html', context)
